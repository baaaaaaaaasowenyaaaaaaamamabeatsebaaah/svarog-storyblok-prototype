...
vi.mock('svarog-ui', () => ({
  ...
  Hero: vi.fn(() => ({
    getElement: () => document.createElement('section'),
    update: vi.fn(),
    destroy: vi.fn()
  })),
  Grid: vi.fn(() => ({
  ...
  Image: vi.fn(() => ({
    getElement: () => document.createElement('img'),
    update: vi.fn(),
    destroy: vi.fn()
  })),
  Header: vi.fn(() => ({
    getElement: () => document.createElement('header'),
    update: vi.fn(),
    destroy: vi.fn()
  })),
  Footer: vi.fn(() => ({
    getElement: () => document.createElement('footer'),
    update: vi.fn(),
    destroy: vi.fn()
  })),
  Navigation: vi.fn(() => ({
    getElement: () => document.createElement('nav'),
    update: vi.fn(),
    destroy: vi.fn()
  })),
  switchTheme: vi.fn(),
...
// Test utilities - only what we need for integration testing
